...
const courseDetailsData = {
  1: {
    ...
    prerequisites:
      "a little bit of Node.js knowledge, and you laptop, yes, just that..",
  },
  2: {
  ...
  3: {
    ...
    syllabus:
      "Learn to Create CI/CD pipelines, Automate the deployment process",
...
const CourseDetails = () => {
  const { id } = useParams();
  // useParams to get the course id from the URL /course-details/3 then id = 3
